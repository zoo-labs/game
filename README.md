...
This repository contains the initial setup and the final version of the ZooCoin clone project, including the basic project structure, necessary images, and icons.

## Overview

This project is a clone of the popular Telegram mini app, ZooCoin. The repository provides two branches:
...
1. **Clone the Repository**:
    ...
    ```bash
    git clone https://github.com/zoo-labs/game.git
    cd game
    ```
